...
describe('core', () => {
  test('exports', () => {
    ...
    assert.equal(typeof core.tempdir, 'function', 'core.tempdir')
    assert.equal(typeof core.tempfile, 'function', 'core.tempfile')
    assert.equal(typeof core.tmpdir, 'function', 'core.tmpdir')
    assert.equal(typeof core.tmpfile, 'function', 'core.tmpfile')
